...
from photos.views import RetroPhotoViewSet, AdminRetroPhotoViewSet, ShootingPointsView
...
urlpatterns = [
    ...
    path('api/photos/shooting-points/', ShootingPointsView.as_view(), name='shooting-points'),
    path('api/locations/check/', CheckLocationView.as_view(), name='location-check'),
    
    # Административные API пути
